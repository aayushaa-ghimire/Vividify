      ...
      <div className='flex flex-col w-full lg:w-1/2 gap-8'>
        <div className='flex flex-col gap-3'>
          ...
          <h1 className="text-3xl lg:text-4xl font-bold leading-tight text-[#111]">
            Driving Your Success with <span className="text-[#0c5adb]">Trusted IT Solutions</span>
          </h1>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          <div className='rounded-2xl border border-blue-50 bg-[#f4f8ff] p-5 shadow-sm transition-all duration-300 hover:shadow-md'>
            <p className="text-base leading-relaxed text-[#403f3f]">
              <span className='font-bold text-[#111]'>Expert Team:</span> Our team of skilled professionals delivers smart, result-driven solutions with precision and expertise.
            </p>
          </div>
          <div className='rounded-2xl border border-blue-50 bg-[#f4f8ff] p-5 shadow-sm transition-all duration-300 hover:shadow-md'>
            <p className="text-base leading-relaxed text-[#403f3f]">
              <span className='font-bold text-[#111]'>Customized Solutions:</span> We create customized strategies that align perfectly with your unique business goals.
            </p>
          </div>
          <div className='rounded-2xl border border-blue-50 bg-[#f4f8ff] p-5 shadow-sm transition-all duration-300 hover:shadow-md'>
            <p className="text-base leading-relaxed text-[#403f3f]">
              <span className='font-bold text-[#111]'>End-to-End Services:</span> We provide seamless support at every stage, from initial concept to final execution.
            </p>
          </div>
          <div className='rounded-2xl border border-blue-50 bg-[#f4f8ff] p-5 shadow-sm transition-all duration-300 hover:shadow-md'>
            <p className="text-base leading-relaxed text-[#403f3f]">
              <span className='font-bold text-[#111]'>Long-Term Partnership:</span> We are committed to building long-term relationships based on trust and continuous growth.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-wrap lg:flex-nowrap gap-6 w-full lg:w-1/2 justify-center'>
        ...
        <div className='flex flex-col w-full sm:w-[280px] p-10 items-center text-center bg-white rounded-3xl border border-gray-100 shadow-xl transition-all duration-300 hover:-translate-y-2'>
          <div className='mb-6 p-4 bg-blue-50 rounded-2xl'>
            <img src="../../public/pricing-icon.png" alt="icon" className="w-12 h-12 object-contain" />
          </div>
          ...
          <div className="text-sm font-medium leading-[2.5] text-[#444] mb-8">
            Modern design <br/> Lead Forms <br/>Responsive Design<br/>24/7 Support
          </div>
        ...
        <div className='flex flex-col w-full sm:w-[280px] p-10 items-center text-center bg-[#000049] text-white rounded-3xl shadow-xl transition-all duration-300 hover:-translate-y-2'>
          <div className='mb-6 p-4 bg-white/10 rounded-2xl'>
            <img src="../../public/pricing-icon.png" alt="icon" className="w-12 h-12 object-contain brightness-0 invert" />
          </div>
          ...
          <a href="#" className="w-full rounded-xl bg-[#0c5adb] text-white px-6 py-3.5 text-sm font-bold transition-all duration-300 hover:bg-white hover:text-[#000049] hover:shadow-lg active:scale-95">
            Purchase
          </a>
        </div>
