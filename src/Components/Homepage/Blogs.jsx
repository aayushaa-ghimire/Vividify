...
//   return (
//     <section className="bg-[#f8faff] py-28 px-12">
//       <div className="max-w-[1400px] mx-auto">
//         <div className="mb-16">
//           <span className="text-blue-600 font-bold tracking-widest text-[11px] uppercase bg-blue-100/50 px-5 py-2 rounded-full">
//             Insights & Blogs
//           </span>
//           <h2 className="text-[50px] font-extrabold text-[#0f172a] mt-6 leading-tight">
...
//                 <h3 className="text-2xl font-bold text-[#1e293b] leading-[1.3] mb-5 group-hover:text-blue-600 transition-colors">
//                   {item.title}
//                 </h3>
...
//                   <a
//                     href="#"
//                     className="text-[#111] font-bold text-sm flex items-center gap-3 group/link"
//                   >
//                     Explore More
//                   </a>
//                 </div>
