...
function Hero() {
  return (
    <div className="relative min-h-screen bg-[#fcfdfe] flex items-center pt-16 pb-12 mb-[5vw] overflow-hidden font-sans">
      <div className="container mx-auto max-w-7xl px-8 md:px-16 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="w-full lg:w-1/2 flex flex-col gap-6 text-center lg:text-left">
            <div className="inline-flex items-center self-center lg:self-start bg-white border border-[#0c5adb]/10 px-4 py-1.5 rounded-full shadow-sm">
              <span className="text-[#0c5adb] text-[0.7rem] font-bold uppercase tracking-widest">
                Full-Service IT Partner
              </span>
            </div>

            <h1 className="text-[2.5rem] md:text-[3.5rem] xl:text-[4.5rem] font-extrabold text-[#0c2946] leading-[1.1] tracking-tight">
              Strategic Tech <br />
          ...
          <div className="w-full lg:w-1/2 grid grid-cols-12 grid-rows-6 gap-3 h-[450px] lg:h-[550px]">
            <div className="col-span-8 row-span-4 rounded-3xl overflow-hidden shadow-xl border-4 border-white group relative">
              <img
            ...
            <div className="col-span-4 row-span-3 rounded-3xl overflow-hidden shadow-lg border-4 border-white group relative">
              <img
