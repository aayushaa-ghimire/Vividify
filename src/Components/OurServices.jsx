...
function OurServices() {
  return (
    <>
    <div className='flex flex-col align-middle mt-[15vw]'>
      <div className='flex justify-center mb-[5vw]'>
        ...
        <div className='flex gap-[2vw] w-[80vw] justify-center'>

          <div className='w-[1vw], gap-[2vw] bg-[#686868 bg-[#E8F0FD] rounded-3xl border-1 border-[#0d5bdb] p-[2vw] flex  flex-col'>
          ...
          <div className='w-[10vw], gap-[2vw] bg-[#686868 bg-[#E8F0FD] rounded-3xl border-1 border-[#0d5bdb] p-[2vw] flex  flex-col'>
